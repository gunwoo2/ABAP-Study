*&---------------------------------------------------------------------*
*& Report  ZBC400_E03_GLOBAL_CLASS_2
*&
*&---------------------------------------------------------------------*
*&
*& Simple calculator + percentage(내가 만든 클래스의 메소드로 변경)
